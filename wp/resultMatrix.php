    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Result Menggunakan Metode WP</h2>
          <p>Hallo, 
            Metode WP adalah .......
        ...
        <div class="tabel">
            <table class="table caption-top">
                ...
                <tbody>
                    ...
                    include '../koneksi.php';
                    $no = 1;
                    $query = "SELECT bobotROC.*,wp_jumbobot.JUMLAH,(bobotROC.valuebobot/wp_jumbobot.jumlah) AS normalisasi_w FROM bobotROC, wp_jumbobot";
                    $result = $koneksi->query($query);
                    while ($row = $result->fetch_array()) { ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
        ...
        <div class="tabel">
            <table class="table caption-top">
                ...
                <tbody>
                    ...
                    include '../koneksi.php';
                    $no = 1;
                    $query = "SELECT wp_nilais.idObject,wp_nilais.nmObject, (nilaiS/jum) AS nilaiV FROM wp_nilais,wp_sums";
                    $result = $koneksi->query($query);
                    while ($row = $result->fetch_array()) { ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
